        ...
        <div class="slideshow-container">
            ...
            <style>
                * {box-sizing: border-box;}
                ...
                .image-btn {
                    /* position: absolute; */
                    background: linear-gradient( to right, #003399, #faf5b2);
                    color: white;
                    padding: 10px 20px;
                ...
                .image-btn:hover{
                    color: white;
                    background: linear-gradient(to left, #003399, #6e4ead);
                    border: white;
                    border-style: double;
...
<div class="mySlides fade" >
  <!-- <div class="numbertext">1 / 3</div> -->
    <div class="w3l-main-slider" >
        <div class="banner-view" style="background-image: url('assets/images/air-freight.png');">
...
<div class="mySlides fade" >
  ...
  <div class="w3l-main-slider" >
    ...
    <div class="banner-view" style="background-image: url('assets/images/wa-freight.png');">
        <div class="banner-info">
            <div class="container">
                <div class="banner-info-bg">
                    <h5>We Provide Best <span class="font-weight-bold">Packing & Moving</span> Services</h5>
...
<div class="mySlides fade">
  ...
  <div class="w3l-main-slider" >
    <div class="banner-view" style="background-image: url('assets/images/freight-slide.png');">
        <div class="banner-info">
            <div class="container">
                <div class="banner-info-bg">
                    <h5>We Provide Best <span class="font-weight-bold">Packing & Moving</span> Services</h5>
        ...
        <div class="container py-md-5 py-sm-4">
            <div class="row align-items-center">
                <div class="col-lg-6 left-wthree-img mb-lg-0 mb-5">
                    <img class="img-fluid img-responsive" src="assets/images/truck.jpeg" alt=" ">
                </div>
                <div class="col-lg-6 about-right-faq align-self pl-lg-5">
                    <h3 class="title-main-2">We have <span>25+</span> years of experience</h3>
                    <p class="mt-2">We connect continents and delivering dreams across. Our goal is to unite the world through seamless logistics solutions </p>
                    <div class="mt-5">
                        <div class="about-info-m d-flex">
                            ...
                            <div class="about-detail">
                                ...
                                <p>Having punctuality at the heart of our logistics commitment has helped us to guarantee time-bound delivery.</p>
                            </div>
                        </div>
                        <div class="about-info-m d-flex mt-4">
                            ...
                            <div class="about-detail">
                                ...
                                <p>Our commitment to secure and safe delivery system ensures that your valuable shipments are in trusted hands with our top-tier logistics services.
                                </p>
                            </div>
                        </div>
                    </div>
