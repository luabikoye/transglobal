            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">New Hubber</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="add-new-hubber.php" 
                                class="btn btn-danger  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Add Hubber
                            </a>
                                
                            <a href="export-new-hubber.php" 
                            ...
                            <a href="bulk-upload-participant.php" 
                                ...
                                <table class="table text-nowrap">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                            ...
                                            <td>sumbo</td>
                                            <td>sumbo</td>
                                            <td><a href="details-new-hubber.php" class="btn btn-success">View</a></td>
