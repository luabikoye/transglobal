                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title">Please select a file to upload <code>Participants</code> </h3>
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="proc-bulk-upload-participant.php" method="post" enctype="multipart/form-data"> 
                                    <!-- </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="">Only Excel/CSV File Import. - <a href="participant_template.csv">Click here to donwload sample template</a></p>
                                        <button type="submit" class="btn btn-success" name="upload" value="submit">Upload</button>
                                    </div>
                                </form>
                            </div>
                        </div>
